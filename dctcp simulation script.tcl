...
Agent/TCP/FullTcp set lddctcp_ 0
Agent/TCP/FullTcp set end_time 0
Agent/TCP/FullTcp set start_time 0
Agent/TCP/FullTcp set sfmw_threshold_ 20

#the initial value flwo_max_cwnd_=1 must be given, or the right value can't be obtained.
Agent/TCP/FullTcp set flow_max_cwnd_ 1  

# how many levels of priority is used. 
Agent/TCP/FullTcp set max_priority 1
Queue/Priority set queue_num_ 1

#the number of nodes¡£
set N 3
#the number of short flows in each group¡£
set M 100
puts "M: $M"
...
Agent/TCP/FullTcp set interval_ 0.001 ; #delayed ACK interval = 100us
...
#trace the maximun cwnd of a flow ever had.           
...
set mytracefile [open trace_sfcwnd.tr a+]
